...
window.Utils = {
    ...
    'ShowCanvas': function ( obj ) {
        ...
        img.onload = function () {// 一边装载一边绘制，解决用户加载等待问题
            ctx.drawImage(img, 0, 0, canvas.width, canvas.height)// 画布中绘制图像
