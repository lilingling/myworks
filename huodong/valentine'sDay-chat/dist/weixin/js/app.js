...
function moveup(){
  ...
  var moveH = wrapperH2 - wrapperH1;
  if(wrapperH2 >= dh){
    $('.wrapper_chat').css('bottom',keyboardH+'px');
    // $('.wrapper_chat').css('-webkit-transform','translateY('+(-moveH)+'px)');
    // $('.wrapper_chat').css('-webkit-transition','transform 1s ease 0s');
  }
};
