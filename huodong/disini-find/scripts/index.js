...
window.Utils = {
    ...
    window.scene3Animation =function(){
        var n=1,f=0;
      ...
      window.scene4Animation =function(){
        var c=0;
      ...
      window.scene5Animation =function(){
        var d=0;
      ...
      function Animation(current,currentId){
        if(current.hasClass('currentScene')){
            var timer = 0;
            if(currentId == 3){
                timer=4400;
            }
            ...
            var funName = "scene"+currentId+"Animation";
            var animT=setTimeout(function(){
