	...
	function wx_verif(force,debug){
		...
		var   verif_Url = ['http://wx.wepiao.com','http://yx.wepiao.com','http://weixin.wepiao.com','http://project.starfruit.net.cn','http://minisite.local'];
