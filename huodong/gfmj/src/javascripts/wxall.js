...
var WxBridge = (function($, wx) {
    ...
    function wx_verif(force,debug){
        ...
        if(verif_Url.indexOf(window.location.origin) == -1){
            console.log("您当前不在微信电影票的认证域名,不能使用分享功能");
            return;
        }
...
//  分享图保存为share.jpg
WxBridge.share({
    'imgUrl' : 'http://weixin.wepiao.com/huodong/wx/20151217/gymj/images/share.jpg', // 图片地址
    'link'   : 'http://weixin.wepiao.com/huodong/wx/20151217/gymj/', // 链接地址
    'title'  : '送你《寻龙诀》观影秘笈一本，速来分金定穴学盗墓吧', // 分享标题
    'desc'   : '人点烛，鬼吹灯，胡八一教你如何盗墓挖宝' // 分享内容(出现在朋友圈分享的文字中)
});
