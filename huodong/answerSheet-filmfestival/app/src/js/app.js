  ...
  $('#getBonus').on('click', function(){
    // $('#packet-box').css('position','absolute');
    // 存储手机号
    ...
    if(android){
      window.location.href = 'wxmovie://hongbao?url=http://b.wepiao.com/hongbao/index.html?pid=02b72c10b38e10c6&channelid=9&chid=10&p=%p%';
    }
    else if(iPhone){
      window.location.href= 'wxmovie://hongbao?url=http://b.wepiao.com/hongbao/index.html?pid=02b72c10b38e10c6&channelid=8&chid=200&p=%p%';
    }
  });
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          if(tag){
            ...
            // localStorage.phone_number=phone_numbers;
            // for(var item in phone_numbers){
            //   console.log("----------")
            //   console.log(phone_numbers[item]+"====="+phone+"\n");
            //   if(phone_numbers[item] == phone){
            //     $('#prompt1').show().text('已经参与过了抽奖了');
            //   }
            // }
            tag = false;
